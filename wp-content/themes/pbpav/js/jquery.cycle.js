    ...
    i.fn.cycle.createPagerAnchor = function(u, v, s, t, w) {
        ...
        if (i.isFunction(w.pagerAnchorBuilder)) {
            ...
            if(w.enableCustom)
            {
                ...
                /*if(w.imageParentIdHover)
                {
                    i(w.imageParentId).hover(                    
                      function (e) 
                      {
                            slideIndex = parseInt(w.currSlide+1);
                            i(w.imageParentId+" #marquee_"+slideIndex+"_div p").slideDown();
                            w.$cont[0].cyclePause++;
                      }, 
                      function (e) {
                            slideIndex = parseInt(w.currSlide+1);
                            i(w.imageParentId+" #marquee_"+slideIndex+"_div p").slideUp();
                            w.$cont[0].cyclePause--;
                    }); 
                }*/
            }
...
{
    if(jQuery("body").css("background-color").indexOf("rgb(21, 11, 9)")!=-1)
    {
       jQuery(".snipe img").each(function(){
            jQuery(this).attr("src", jQuery(this).attr("src").replace(/_white.png/g,'_black.png'));
