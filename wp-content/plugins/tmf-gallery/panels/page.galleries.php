<?php $hookName = TMFGAdminPages::$hookName['galleries']; ?>
...
<div class="wrap">
	<?php screen_icon(); ?>
	<h2>TMF Gallery - <?php _e('Manage Galleries', TMFG::i18nDomain) ?></h2>
	
	<div id="tmfg-messagebox" class="below-h2" style="display: none;">
		<p>Test</p>
	</div>
